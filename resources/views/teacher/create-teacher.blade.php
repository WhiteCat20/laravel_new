      ...
      <div class="card-body">
        <form action="/teacher" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="teacher_number" class="@error('teacher_number') is-invalid @enderror form-control" id="teacher_number" value="{{ old('teacher_number') }}">
          ...
          <div class="mb-3">
            ...
            <input type="email" name="email" class="@error('email') is-invalid @enderror form-control" id="email" value="{{ old('email') }}">
            @error('email')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="phone_number" class="@error('phone_number') is-invalid @enderror form-control" id="phone_number" value="{{ old('phone_number') }}">
            @error('phone_number')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
